...
<html>
<head>
	<title>Admissions - learnGH</title>
	<!-- Meta Tag -->
    <meta charset="UTF-8">
						...
						<div class="profile-wrapper">
                            ...
                            <div class="search-m-2">
                                <form action="" method="get">
                                    <input type="search" name="search" value="" placeholder="filter admission list">
                                </form>
                            </div>
                            <div class="admission-list">
                                <p class="cat-m-2">University</p>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>

                                <p class="cat-m-2">Tech. University</p>
                                <ul>
                                    <li><a href=""></a></li>
                                </ul>

                                <p class="cat-m-2">Training/Colleges</p>
                                <ul>
                                    <li><a href=""></a></li>
                                </ul>

                                <p class="cat-m-2">S.H.S</p>
                                <ul>
                                    <li><a href=""></a></li>
                                </ul>

                                <p class="cat-m-2">Technical</p>
                                <ul>
                                    <li><a href=""></a></li>
                                </ul>

                                <p class="cat-m-2">J.H.S/Primary/Crech/K.G</p>
                                <ul>
                                    <li><a href=""></a></li>
                                </ul>
                            </div>
