...
<html>
<head>
	<title>Results Checking - learnGH</title>
	<!-- Meta Tag -->
    <meta charset="UTF-8">
					...
					<div class="col-md-3">
						<div class="profile-wrapper">
							<div class="profile_pic">
                                <a href="user-account.php"><img src="#" class="img-circle" width="" height="" alt="profile_pic"></a>
                            ...
                            <div class="profile_list_items_2">
                                <ul>
                                    <li><a href="check-results.php">Check Results (class/waec)</a></li>
                                    <li><a href="file-results.php">File Results (class/school)</a></li>
                                    <li><a href="form-classroom.php">Create Class Page</a></li>
                                </ul>
                            </div>

                            <hr>

                            <div class="profile_list_items_3">
                                <ul>
                                    <li><a href="take-conduct-exams.php">Conduct/Take Exams</a></li>
                                    <li><a href="live-stream-lectures.php">Live Stream Lectures</a></li>
                                </ul>
                            </div>
					...
					<div class="col-md-6">
				      	<div class="feeds_wrapper">
					      	<div class="school-results">
                                <a href="#"><img src="img/" class="img-thumbnail"></a>
                            </div>

                            <hr>

                            <div class="waec-results">
                                <a href="http://www.waec-direct.com.gh" target="_blank"><img src="img/" class="img-thumbnail"></a>
                            </div>

                            <hr>

                            <div class="publish_school">
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Location of Your School:</td>
                                        <td><?php ?></td>
                                    </tr>

                                    <tr>
                                        <td>Name of Your Class Teacher:</td>
                                        <td><?php ?></td>
                                    </tr>
                                </table>
                            </div>
