...
<html>
<head>
	<title>Streaming Live - learnGH</title>
	<!-- Meta Tag -->
    <meta charset="UTF-8">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
				      	<div class="feeds_wrapper">
					      	<article>
                                <p>Live Streaming</p>
                                <p>You are about to <b>Go Live</b>, make sure your sound and video quality are
                                    <span class="glyphicon glyphicon-check"></span></p>
                            </article>

                            <div class="live-stream">
                                <iframe class="">
                                    <video poster="" autoplay></video>
                                </iframe>
                            </div>
				      	</div>
					</div>
