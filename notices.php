...
<html>
<head>
	<title>Notice Board - learnGH</title>
	<!-- Meta Tag -->
    <meta charset="UTF-8">
						...
						<div class="profile-wrapper">
                            ...
                            <div class="search-m-2">
                                <form action="" method="get">
                                    <input type="search" name="search" value="" placeholder="filter notices">
                                </form>
                            </div>
                            <div class="notices-list">
                                <p class="cat-m-2">Personal</p>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>

                                <p class="cat-m-2">Government</p>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>

                                <p class="cat-m-2">G.E.S</p>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>

                                <p class="cat-m-2">Schools</p>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>
                                <p class="cat-m-2">Theology</p>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>
                                <p class="cat-m-2">Uncategorised</p>
                                <ul>
                                    <li><a href="#"></a></li>
                                </ul>
                            </div>
